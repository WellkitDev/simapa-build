...
@section('title', 'Buat Order Jurnal - SiMAPA')
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div>
            <h5 class="mb-0">Tambah Order Jurnal Baru</h5>
        </div>
        <div>
    ...
    <form method="POST" action="{{ route('order.journal.store') }}" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select name="type" class="form-select" required>
                                    ...
                                    <option value="at_mandiri" {{ old('type', $prefill['type'] ?? '') === 'at_mandiri' ? 'selected' : '' }}>Mandiri</option>
                                    <option value="at_kolab" {{ old('type', $prefill['type'] ?? '') === 'at_kolab' ? 'selected' : '' }}>Kolaborasi</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select name="indexation" class="form-select select2" required>
                                    ...
                                    <option value="scopus q5">Scopus Q5</option>
                                    <option value="scopus q6">Scopus Q6</option>
                                    <option value="ebsco">EBSCO</option>
                                    <option value="doaj">DOAJ</option>
                                    <option value="coppernicus">Copernicus</option>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        @include('orders.partials.pemilik')
