...
@section('content')
    <div class="container py-5">
        <h1 class="mb-4">Tambah Order Jurnal Baru</h1>
        ...
        <form method="POST" action="">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <select name="type" class="form-select" required>
                                ...
                                <option value="at_mandiri">Artikel Mandiri</option>
                                <option value="at_kolab">Artikel Kolaborasi</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3 mb-3">
                            <label class="form-label">Target Indeksasi (contoh: SINTA 2)</label>
                            <input type="text" name="indexation" class="form-control"
                                placeholder="SINTA 2, Scopus, dll.">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6 mb-3">
            ...
            <div class="text-start">
                ...
                <a href="{{ route('order.book.index') }}" class="btn btn-secondary btn-lg ms-2">Batal</a>
            </div>
        </form>
    </div>
@endsection
