    ...
    <div class="row">
        <div class="col-xl-10 main-content ps-xl-4 pe-xl-5">
            ...
            <p class="lead">Use Bootstrap’s custom button styles for actions in forms, dialogs, and more with support for
                multiple sizes, states, and more. Read the <a href="https://getbootstrap.com/docs/5.3/components/buttons/"
                    target="_blank">Official Bootstrap Documentation</a> for a full list of instructions and other options.
            </p>

            <hr>

            <h4 id="default">Basic Examples</h4>
            <p class="mb-3">Bootstrap includes several predefined button styles, each serving its own semantic purpose,
...
<button type="button" class="btn btn-inverse-dark">Dark</button></script></code></pre>
            ...
            <p class="mb-3">The <code>.btn</code> classes are designed to be used with the <code>&lt;button&gt;</code>
                element. However, you can also use these classes on <code>&lt;a&gt;</code> or <code>&lt;input&gt;</code>
...
<input class="btn btn-primary" type="reset" value="Reset"></script></code></pre>
            ...
            <p class="mb-3">In need of a button, but not the hefty background colors they bring? Replace the default
                modifier classes with the <code>.btn-outline-*</code> ones to remove all background images and colors on any
                button.</p>
            <div class="example">
            ...
            <p class="mb-3">Fancy larger or smaller buttons? Add <code>.btn-lg</code> or <code>.btn-sm</code> for
                additional sizes.</p>
            <div class="example">
...
<button type="button" class="btn btn-primary btn-xs">Extra small</button></script></code></pre>
  ...
  <button type="button" class="btn btn-secondary">Block level button</button>
                ...
                <button type="button" class="btn btn-clipboard"
                    data-clipboard-target="#defaultBreadcrumbs">copy</button>
            </figure>

            <hr>

            <h4 id="active">Active state</h4>
            <p class="mb-3">Buttons will appear pressed (with a darker background, darker border, and inset shadow) when
                active. <strong>There’s no need to add a class to <code>&lt;button&gt;</code>s as they use a
                    pseudo-class</strong>. However, you can still force the same active appearance with <code>.active</code>
                (and include the <code>aria-pressed="true"</code> attribute) should you need to replicate the state
                programmatically.</p>
            <div class="example">
                <a href="javascript:;" class="btn btn-primary active" role="button" aria-pressed="true">Primary
                    link</a>
...
<a href="#" class="btn btn-secondary active" role="button" aria-pressed="true">Link</a></script></code></pre>
            ...
            <p class="mb-3">Make buttons look inactive by adding the <code>disabled</code> boolean attribute to any
...
<button type="button" class="btn btn-secondary" disabled>Button</button></script></code></pre>
            ...
            <p class="mb-3">Disabled buttons using the <code>&lt;a&gt;</code> element behave a bit different.
                <code>&lt;a&gt;</code>s don’t support the <code>disabled</code> attribute, so you must add the
                <code>.disabled</code> class to make it visually appear disabled.
            </p>
            <div class="example">
                <a href="javascript:;" class="btn btn-primary disabled" tabindex="-1" role="button"
                    aria-disabled="true">Primary link</a>
                <a href="javascript:;" class="btn btn-secondary disabled" tabindex="-1" role="button"
...
<button type="button" class="btn btn-danger btn-icon">
  <i data-feather="box"></i>
            ...
            <p class="mb-3">Wrap icon and text inside <code>.btn-icon-text</code> and use <code>.btn-icon-prepend</code>
...
<button type="button" class="btn btn-icon-text btn-outline-twitter">
  ...
  Twitter
    ...
    <div class="row">
        <div class="col-xl-10 main-content ps-xl-4 pe-xl-5">
            ...
            <p class="lead">Group a series of buttons together on a single line or stack them in a vertical column. Read
                the <a href="https://getbootstrap.com/docs/5.3/components/button-group/" target="_blank">Official
  ...
  <button type="button" class="btn btn-primary">Right</button>
            ...
            <p class="mb-3">Combine button-like checkbox and radio <a
                    href="https://getbootstrap.com/docs/5.3/forms/checks-radios/" target="_blank">toggle buttons</a> into
                a seamless looking button group.</p>
            <div class="example">
  ...
  <label class="btn btn-outline-primary" for="btnradio3">Radio 3</label>
            ...
            <p class="mb-3">Combine sets of button groups into button toolbars for more complex components. Use utility
  ...
  <div class="btn-group" role="group" aria-label="Third group"> ... </div>
            ...
            <p class="mb-3">Feel free to mix input groups with button groups in your toolbars. Similar to the example
...
<div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control" placeholder="Input group example" aria-label="Input group example" aria-describedby="btnGroupAddon2">
            ...
            <p class="mb-3">Instead of applying button sizing classes to every button in a group, just add
                <code>.btn-group-*</code> to each <code>.btn-group</code>, including each one when nesting multiple groups.
            </p>
            <div class="example">
...
<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
  ...
  <button type="button" class="btn btn-primary">Right</button>
            ...
            <p class="mb-3">Place a <code>.btn-group</code> within another <code>.btn-group</code> when you want dropdown
  ...
  <div class="btn-group" role="group">
    ...
    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      ...
      <a class="dropdown-item" href="#">Dropdown link</a>
            ...
            <p class="mb-3">Make a set of buttons appear vertically stacked rather than horizontally. Split button
    ...
    ...
                ...
                <button type="button" class="btn btn-clipboard"
                    data-clipboard-target="#verticalVariations">copy</button>
            </figure>
